...
void airfucking(int l1,int l2,int l3,int r3,int r2,int r1)
{
    TCRT_detect();
    double value = 0.0;
    if((l1 + l2 + l3 + r1 + r2 + r3) == 0)value = 0;
    ...
    if(value < 0)
    {
        MotorWriting(170 - 30 * value, 170 + 30 * value);
        delay(3);
        MotorWriting(0, 0);
        delay(7);
    }
...
void airfucking_back(int l1,int l2,int l3,int r3,int r2,int r1)
{
    TCRT_detect();
    double value = 0.0;
    if((l1 + l2 + l3 + r1 + r2 + r3) == 0)value = 0;
    ...
    if(value < 0)
    {
        MotorWriting(-150 + 30 * value, -150 - 30 * value);
        delay(20);
        MotorWriting(0, 0);
        delay(3);
    }
